...
def _b1k_8task_episode_filter(ep):
    return int(ep["task_index"]) in B1K_8_TASK_IDS
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                dataset_root="/data2/yuxi.wang/yuxi_wang/xieshuaiyang/2026-challenge-demos",
                prompt_from_task=True,
                dataset_kwargs={"tolerance_s": 5e-4},
            ),
            robot_config_name="b1k/R1Pro",
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("/data2/yuxi.wang/yuxi_wang/xieshuaiyang/checkpoints/openpi_base_params/openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                dataset_kwargs={
                    "tolerance_s": 5e-4,
                    "episode_filter": _b1k_8task_episode_filter,
                    },
            ),
            robot_config_name="b1k/R1Pro",
        ),
